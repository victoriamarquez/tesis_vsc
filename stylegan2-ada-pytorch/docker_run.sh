...
if [[ "${CONTAINER_ID}" ]]; then
    ...
    docker run --shm-size=2g --gpus all -it \
    -v `pwd`:/scratch --user $(id -u):$(id -g) \
    --workdir=/scratch -e HOME=/scratch $IMAGE ls /scratch/images/aligned_images \
    -v /mnt/discoAmpliado/viky/images/aligned_images:/scratch/images/aligned_images \
    -v /mnt/discoAmpliado/viky/images/processed_images:/scratch/images/processed_images \
