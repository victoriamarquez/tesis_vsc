...
def linearRegression(df, idUnique, emotion):
    logging.info(f'[linearRegression] [→] Calculating Linear Regression for person: {idUnique}, emotion: {emotion}.')
    ...
    logging.info(f'[linearRegression] [✔] Calculated Linear Regression for person: {idUnique}, emotion: {emotion}.')
