...
images_data = create_image_dict(base_dir)

align_all_images(images_data[0:2])
...
logging.debug('PCA and Linear Regression completed successfully.')
...
##print('PCA and Linear Regression results normalized successfully.')
